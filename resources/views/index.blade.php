...
<body class="text-gray-800">
  ...
  <header
    ...
    <div class="relative z-10 text-center p-6">
      <h1
        ...
        Le Corsaire Ballet - Clássicos da Disney
      </h1>
      <p
      ...
      <div class="container mx-auto max-w-5xl">
        ...
        <div class="grid md:grid-cols-1 gap-8">
          ...
          <div
            ...
            <a
              href="{{ route('buy') }}"
              class="btn-magic w-full mt-4 inline-block bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-8 rounded-full text-lg">Comprar Agora</a>
          </div>
          <!-- Cartão de Bilhete 2 -->
          <!-- <div
        ...
        <div class="space-y-4">
          <div
            ...
            <div
              ...
              <i
                class="fas fa-plus icon-plus text-blue-500 transition-transform duration-300"></i>
            </div>
  ...
  <footer class="bg-blue-900 text-white py-12 px-6">
    <div class="container mx-auto text-center">
      <p class="font-title text-4xl mb-4">Le Corsaire Ballet</p>
      <p class="mb-6">
      ...
      <div class="flex justify-center space-x-6 mb-8">
        <a
          ...
          class="text-2xl hover:text-blue-300 transition-colors"><i class="fab fa-instagram"></i></a>
        ...
        <a
          ...
          class="text-2xl hover:text-blue-300 transition-colors"><i class="fab fa-whatsapp"></i></a>
      </div>
      <p class="text-sm text-blue-200">
        &copy; 2025 Le Corsaire Ballet. Todos os direitos reservados.
      </p>
    </div>
  </footer>
